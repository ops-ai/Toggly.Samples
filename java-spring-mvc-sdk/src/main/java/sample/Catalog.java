...
public final class Catalog {
    private Catalog() {}
    public static final List<String> PATHS = List.of("/", "/gates", "/programmatic", "/identity", "/orders", "/filters", "/mvc", "/configuration");
    public static final List<String> TITLES = List.of("Home", "Declarative gates", "Programmatic API", "Identity", "Entity context", "Filters matrix", "Spring MVC integration", "Configuration");
