...
public final class PackagedProbe {
    public static void main(String[] args) throws Exception {
        ...
        try (var definitions = new DefinitionsServer(); var app = Main.start(8089, definitions.lifecycle()); var http = HttpClient.newHttpClient()) {
            for (String path : new String[]{"/", "/gates", "/programmatic", "/identity", "/orders", "/filters", "/webflux", "/configuration", "/style.css", "/gated/beta?preset=matching", "/api/evaluate?preset=matching"}) {
