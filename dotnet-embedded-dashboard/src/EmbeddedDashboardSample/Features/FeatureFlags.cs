...
public static class FeatureFlags
{
    ...
    public static readonly string[] Filters = ["filter-always-on", "filter-percentage", "filter-targeting", "filter-user-claims",
        "filter-time-window", "filter-country", "filter-browser-family", "filter-browser-language", "filter-device-type", "filter-os", "filter-context-property"];
}
