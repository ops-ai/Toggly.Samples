...
| Java Spring Boot SDK Sample | Spring Boot 3.5.16 + starter 1.6.0 | [`java-spring-boot-sdk/`](java-spring-boot-sdk/) | Starter auto-config, `@FeatureEnabled` / `@ConditionalOnFeature`, request context, Actuator, Order and eleven-filter matrix |
