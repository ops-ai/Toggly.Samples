...
module RubyShowcase
  module Catalog
    SECTIONS = {
      ...
      '/gates' => ['Declarative gates', 'Compose native booleans in ERB: feature, negate, Any and All.'],
      '/api' => ['Programmatic API', 'Protect an HTTP route and a state-changing action.'],
      '/identity' => ['Identity', 'Keep a demo persona in this browser’s signed session.'],
