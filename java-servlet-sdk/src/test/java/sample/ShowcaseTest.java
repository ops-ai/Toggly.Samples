...
class ShowcaseTest {
    @Test void missingKeyIsVisibleAndEveryProtectedRouteDenies() throws Exception {
        try (var app = Main.start(0, SampleLifecycle.unconfigured()); var http = HttpClient.newHttpClient()) {
            ...
            for (String route : new String[]{"/gated/feature", "/gated/negate", "/gated/all", "/gated/any", "/gated/beta"}) {
